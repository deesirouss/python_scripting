...
class Deck:
  ...
  def __init__(self):
    ...
    for suit in suits:
      for rank in ranks:
        # building Card objects and add them to the list
...
class Chips:
  ...
  def __init__(self):
    # This can be set to a default value or supplied by a user input(Using default value)
    self.total = 100  
    self.bet = 0
...
playing = True
# a function for asking player to hit or stand
